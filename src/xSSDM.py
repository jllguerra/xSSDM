...
#         self.populateFileSystemTreeStore(self.fileSystemTreeStore, files, currentIter)
    ...
    def New_Pamcrash_Sim(self,widget,data=None):
      self.soft='pamcrash';
      self.gtk_NewSimulation(widget,data)
      
    def New_Nastran_Sim(self,widget,data=None):
      self.soft='nastran';
      self.gtk_NewSimulation(widget,data)
    
    def New_OF_Sim(self,widget,data=None):
      self.soft='of';
      self.gtk_NewSimulation(widget,data)
    
    def New_Abaqus_Sim(self,widget,data=None):
      self.soft='abaqus';
      self.gtk_NewSimulation(widget,data)
...
#        response=Gtk.ResponseType.REJECT
        ...
        for filter in listfilters:
          self.selectFileWindow.remove_filter(filter)
        
        extension=['']
        if self.soft == 'pamcrash':
          extension=['*.pc']
        elif self.soft == 'nastran':
          extension=['*.dat','*.bdf']
        elif self.soft == 'abaqus':
          extension=['*.inp']
        elif self.soft == 'of':
          extension=['*.sdm']
        ...
        for ext in extension:
          ...
          self.selectFileWindow.add_filter(filter)
